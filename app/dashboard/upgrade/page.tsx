      ...
      <div className="py-24 sm:py-32">
        ...
        <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-w-4xl">
          ...
          <div className="ring-2 ring-indigo-600 rounded-3xl p-8">
            ...
            <p className="mt-6 flex items-baseline flex-col gap-x-1">
              <span>
                <span className="text-4xl font-bold tracking-tight text-gray-900">
                  $1
                </span>
              ...
              <p>
                <span className="text-4xl line-through font-bold tracking-tight text-gray-900">
                  $5.99
                </span>
                <span className="text-sm font-semibold leading-6 text-gray-600">
                  / month
            ...
            <Button
              className="bg-[#e079b5] w-full text-white shadow-sm hover:bg-indigo-500 mt-6 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
